...
namespace Appccelerate.StateMachine.Extensions
{
        ...
        where TEvent : IComparable
    {
        ...
        public virtual void EventQueued(IStateMachineInformation<TState, TEvent> stateMachine, TEvent eventId,
        ...
        /// <param name="eventId">The event id.</param>
        /// <param name="eventArgument">The event argument.</param>
        public virtual void EventQueuedWithPriority(IStateMachineInformation<TState, TEvent> stateMachine,
        ...
        public virtual void SwitchedState(IStateMachineInformation<TState, TEvent> stateMachine,
        ...
        public virtual void InitializingStateMachine(IStateMachineInformation<TState, TEvent> stateMachine,
        ...
        public virtual void InitializedStateMachine(IStateMachineInformation<TState, TEvent> stateMachine,
            TState initialState)
        {
        }
        ...
        public virtual void EnteredInitialState(IStateMachineInformation<TState, TEvent> stateMachine, TState state,
        ...
        public virtual void FiringEvent(IStateMachineInformation<TState, TEvent> stateMachine, ref TEvent eventId,
        ...
        public virtual void FiredEvent(IStateMachineInformation<TState, TEvent> stateMachine,
            ITransitionContext<TState, TEvent> context)
        {
        }
        ...
        public virtual void HandlingEntryActionException(IStateMachineInformation<TState, TEvent> stateMachine,
        ...
        public virtual void HandledEntryActionException(IStateMachineInformation<TState, TEvent> stateMachine,
            IState<TState, TEvent> state, ITransitionContext<TState, TEvent> context, Exception exception)
        {
        }
        ...
        /// <param name="context">The context.</param>
        /// <param name="exception">The exception. Can be replaced by the extension.</param>
        public virtual void HandlingExitActionException(IStateMachineInformation<TState, TEvent> stateMachine,
            IState<TState, TEvent> state, ITransitionContext<TState, TEvent> context, ref Exception exception)
        {
        }
        ...
        /// <param name="context">The context.</param>
        /// <param name="exception">The exception.</param>
        public virtual void HandledExitActionException(IStateMachineInformation<TState, TEvent> stateMachine,
            IState<TState, TEvent> state, ITransitionContext<TState, TEvent> context, Exception exception)
        {
        }
        ...
        /// <param name="exception">The exception. Can be replaced by the extension.</param>
        public virtual void HandlingGuardException(IStateMachineInformation<TState, TEvent> stateMachine,
        ...
        /// <param name="transitionContext">The transition context.</param>
        /// <param name="exception">The exception.</param>
        public virtual void HandledGuardException(IStateMachineInformation<TState, TEvent> stateMachine,
            ITransition<TState, TEvent> transition, ITransitionContext<TState, TEvent> transitionContext,
            Exception exception)
        {
        }
        ...
        /// <param name="context">The context.</param>
        /// <param name="exception">The exception. Can be replaced by the extension.</param>
        public virtual void HandlingTransitionException(IStateMachineInformation<TState, TEvent> stateMachine,
        ...
        /// <param name="transitionContext">The transition context.</param>
        /// <param name="exception">The exception.</param>
        public virtual void HandledTransitionException(IStateMachineInformation<TState, TEvent> stateMachine,
            ITransition<TState, TEvent> transition, ITransitionContext<TState, TEvent> transitionContext,
            Exception exception)
        {
        }
